\subsection{UC15 - Autenticazione su \glossario{Piattaforma Riunioni} esterna}
\begin{itemize}
	...
	\item \textbf{Scenario principale}: \begin{enumerate}
		\item Utente deve fare il login (UC15.1) ed il bot fornisce il link per effettuare il login su \glossario{Piattaforma Riunioni} esterna; 
		\item Utente inserisce \glossario{access token} ricevuto dopo aver effettuato il login. (UC15.3)
	\end{enumerate}
\end{itemize}

\subsubsection{UC15.1 - Autenticazione su Piattaforma Riunioni esterna }
\begin{itemize}
...
\subsubsection{UC15.2 - Errore Autenticzione su Piattaforma Riunioni esterna}
\begin{itemize}
...
\subsubsection{UC15.3 - Inserimento \glossario{access token} per autenticazione }
\begin{itemize}
...
\subsubsection{UC15.4 - Errore Inserimento access token }
\begin{itemize}
