...
\begin{itemize}
	...
	\item \textbf{Postcondizione}: Il chatbot fornisce un link attraverso il quale l'utente potrà autenticarsi alla piattoforma esterna, ottenendo \glossario{access token}
	\item \textbf{Scenario principale}: \begin{enumerate}
...
\begin{itemize}
	...
	\item \textbf{Scenario principale}: \begin{enumerate}
		\item Utente inserisce l'\glossario{access token} ricevuto a seguito del login nella piattaforma esterna; 
