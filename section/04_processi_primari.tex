...
\subsection{Processo di Sviluppo}
  ...
  Le aspettative del gruppo possono riassumersi in:
    ...
    \end{tabular}
		...
		\paragraph{Strumenti} \hfill \break
		\begin{itemize}
      \item \textbf{\glossario{Visual Studio Code}}: utilizzato per la scrittura di codice in linguaggio \glossario{PYTHON};
      \item 
    \end{itemize}
    ...
    \begin{itemize}
      ...
      \item Scopo: il codice deve essere commentato,per permettere una comprensione più facile da diversi membri del gruppo.
    \end{itemize}
