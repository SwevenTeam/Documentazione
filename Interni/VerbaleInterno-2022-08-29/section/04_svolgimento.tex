...
Andrea fa vedere il diagramma \glossario{UML} della classi unico per server e client, essendo il server stateless, mentre i diagrammi di sequenza sono distinti tra client e server.
