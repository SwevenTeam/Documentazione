\maketitle
    ...
    \begin{center}
        \LARGE{\textbf{Sintesi}} 
    \end{center}
    \normalsize{Riunione interna del gruppo a seguito del responso del professore Cardin Riccardo che invita a sistemare la documentazione prima di poter procedere}
	\thispagestyle{empty}   
	\newpage